                ...
                <Col sm={6} md={6} >
                    <Form className="mt-2 p-5 text-start shadow">
                        <Form.Group>
                            ...
                            <Row>
                                <Col sm={5} md={5}>
                                    <Row className="text-start">
                                        ...
                                        <Form.Control className="input ms-2" type="text" maxLength={100} onChange={(event) => setName(event.target.value)} />
                                    </Row>
                                </Col>
                            ...
                            <Row>
                                <Col sm={5} md={5}>
                                    <Row className="text-start">
                                        ...
                                        <Form.Control className="input ms-2" type="number" min={18} max={100} onChange={(event) => setAge(event.target.value)} />
                                    </Row>
                                </Col>
                            ...
                            <Row>
                                <Form.Label /> <b> Mô tả bản thân<span style={{color:'red'}}>*</span> </b>
